...
import { ASAAS_PRODUCTION_CONFIRMATION } from "@/domains/infrastructure/billing/asaas-runtime";
...
describe("Asaas production billing preflight", () => {
  ...
  it("fails closed and returns actionable issue codes while the kill switch is off", () => {
