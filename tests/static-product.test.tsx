...
function currencyMatcher(cents: number) {
  const expected = normalizeVisibleText(formatCurrency(cents));

  return (_content: string, element: Element | null): boolean => {
    return normalizeVisibleText(element?.textContent ?? "") === expected;
  };
}
