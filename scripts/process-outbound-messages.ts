...
export async function main(){assertSafeWorkerEnvironment();assertExternalEffectAllowed("sandbox");return new OutboundMessageWorker(getPrismaClient(),createProductionProviderRegistry(),new EnvironmentCredentialStore()).run(20)}
