...
import { AppointmentService, ProfessionalService, ProcedureService, QuickPatientService, ResourceService, ScheduleBlockService, WorkingHoursService } from "./services";
import { CommercialClinicService } from "./commercial-plan-quota";
