...
export const permissions = [
  "organization.read", "organization.update", "team.read", "team.invite", "team.update_role", "team.manage_clinic_access", "team.suspend", "team.revoke", "team.transfer_ownership",
...
const matrix: Record<MembershipRole, ReadonlySet<Permission>> = {
  ...
  MANAGER: new Set([...operational,"team.read","team.manage_clinic_access","audit.read","organization.update","integrations.manage"]),
