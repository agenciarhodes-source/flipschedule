...
export async function getApplicationContext(): Promise<ApplicationContext> {
  ...
  return { userId: context.userId, membershipId: context.membershipId, membershipRole: context.membershipRole, tenantId: context.tenantId, tenantSlug: context.tenantSlug, displayName: context.displayName, email: context.email };
}
